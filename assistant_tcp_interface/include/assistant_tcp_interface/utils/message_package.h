...
#include "assistant_tcp_interface/utils/message_serializer.h"
#include "assistant_tcp_interface/utils/message_size.h"
...
public:
  using _type_variants = boost::variant<bool, char, uint8_t, uint32_t, int32_t, float, double, vector6f_t, vector6i_t,
                                        std::string, vectorImageData, vectorstr_t>;
  /**
