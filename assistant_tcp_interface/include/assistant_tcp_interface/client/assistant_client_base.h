...
#ifndef ASSISTANT_TCP_INTERFACE__ASSISTANT_CLIENT_BASE_H
#define ASSISTANT_TCP_INTERFACE__ASSISTANT_CLIENT_BASE_H
...
class AssistantClientBase {

protected:
  AssistantClientBase() {}

public:
  virtual ~AssistantClientBase() {}

  virtual bool initialize(const AssistantTcpClientInterfaceParameters &params) = 0;
